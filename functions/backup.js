...
exports.handler = async function(context, event, callback) {
    ...
    console.log("Message at start: ", messageBody);
    const name = event.ProfileName;
    const WhatsappProfileName = event.ProfileName;
    ...
    try {
        ...
        console.log("Message at convo: ", messageBody);
...
*/
        ...
        console.log("Message at Segment call: ", messageBody);
...
async function writeTraitsToSegment(analytics, userId, traits) {
    try {
        ...
        console.log("Traits written to segment successfully with the traits: ", traits);
    } catch (error) {
